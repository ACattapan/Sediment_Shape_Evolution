% load('CIRC_FIT_MODEL_AVG_NormCirc_ARENITES_PATH_1_SourceDist_PAPER.mat','C0','C_E','a_Opt','Ka_Opt','lambda_Opt','mu_L','L','L_plot')
load('CIRC_FIT_MODEL_AVG_NormCirc_ARENITES_PATH_1.mat')
load('STATS_OVERVIEW_ARENITES_NormCirc.mat')
load('DATA_IMPORT_ARENITES_NormCirc.mat')
load('TRAVEL_DISTANCES_ARENITES_NormCirc.mat')
%                   PLOT Fig_1
addpath(genpath('..'))
color_palette="imola";
