function Circularity_Fit_Model_Quantiles_Ka(X,Parameters,Fitting_Param,FitTest,CLowerC0,PathNum,Circularity_Fit_Model_Quantiles_file,mu_max,C_max,C0,a,Ka)
% 
%--------------------------------------------------------------------------
arguments
    X (:,:) cell
